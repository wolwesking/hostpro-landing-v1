...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="chunk"><div>${validate_component(Listing, "Listing").$$render($$result, { plans, title: "Dedicated Server Hosting" }, {}, {})}</div></section>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-tU0LVhSk.js.map
