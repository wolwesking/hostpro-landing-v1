...
const css$3 = {
  code: ".container.svelte-16e916b{max-width:1200px}section.svelte-16e916b{background-color:#1f2937}",
  map: `{"version":3,"file":"Contact.svelte","sources":["Contact.svelte"],"sourcesContent":["<script>\\n\\tconst discordInviteLink = 'https://discord.gg/BMPbaMeCa5'; // Replace with your actual Discord invite link\\n<\/script>\\n\\n<section id=\\"contact\\" class=\\"w-full py-12 md:py-24 lg:py-32 bg-gray-900\\">\\n\\t<div class=\\"container mx-auto px-4 md:px-6\\">\\n\\t\\t<div class=\\"flex flex-col items-center justify-center text-center space-y-6\\">\\n\\t\\t\\t<h2 class=\\"text-3xl font-bold tracking-tighter sm:text-5xl text-white mb-4\\">\\n\\t\\t\\t\\tJoin Us on Discord\\n\\t\\t\\t</h2>\\n\\t\\t\\t<p class=\\"text-gray-300 md:text-lg lg:text-base xl:text-lg mb-8\\">\\n\\t\\t\\t\\tConnect with our community and get the latest updates!\\n\\t\\t\\t</p>\\n\\t\\t\\t<a\\n\\t\\t\\t\\thref={discordInviteLink}\\n\\t\\t\\t\\ttarget=\\"_blank\\"\\n\\t\\t\\t\\trel=\\"noopener noreferrer\\"\\n\\t\\t\\t\\tclass=\\"inline-flex items-center px-6 py-3 text-base font-medium text-white bg-blue-600 rounded-md shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2\\"\\n\\t\\t\\t>\\n\\t\\t\\t\\tJoin Discord\\n\\t\\t\\t</a>\\n\\t\\t</div>\\n\\t</div>\\n</section>\\n\\n<style>\\n\\t.container {\\n\\t\\tmax-width: 1200px;\\n\\t}\\n\\tsection {\\n\\t\\tbackground-color: #1f2937; /* Dark gray background */\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA0BC,yBAAW,CACV,SAAS,CAAE,MACZ,CACA,sBAAQ,CACP,gBAAgB,CAAE,OACnB"}`
};
const discordInviteLink = "https://discord.gg/BMPbaMeCa5";
const Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$3);
  return `<section id="contact" class="w-full py-12 md:py-24 lg:py-32 bg-gray-900 svelte-16e916b"><div class="container mx-auto px-4 md:px-6 svelte-16e916b"><div class="flex flex-col items-center justify-center text-center space-y-6"><h2 class="text-3xl font-bold tracking-tighter sm:text-5xl text-white mb-4" data-svelte-h="svelte-501zxa">Join Us on Discord</h2> <p class="text-gray-300 md:text-lg lg:text-base xl:text-lg mb-8" data-svelte-h="svelte-11xe14b">Connect with our community and get the latest updates!</p> <a${add_attribute("href", discordInviteLink, 0)} target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-blue-600 rounded-md shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Join Discord</a></div></div> </section>`;
});
const css$2 = {
  code: ".container.svelte-1fbxhmw{max-width:1200px}",
  map: `{"version":3,"file":"Features.svelte","sources":["Features.svelte"],"sourcesContent":["<script>\\n\\timport { ServerIcon, ShieldCheckIcon, ZapIcon, DollarSignIcon } from 'lucide-svelte';\\n<\/script>\\n\\n<section\\n\\tid=\\"features\\"\\n\\tclass=\\"w-full py-16 md:py-28 lg:py-36 bg-gradient-to-r from-gray-800 to-gray-900\\"\\n>\\n\\t<div class=\\"container mx-auto px-6 lg:px-8\\">\\n\\t\\t<h2 class=\\"text-4xl font-extrabold tracking-tight sm:text-5xl text-center mb-10 text-white\\">\\n\\t\\t\\tWhy Choose Hostpro?\\n\\t\\t</h2>\\n\\t\\t<p class=\\"text-lg text-gray-300 text-center mb-12\\">\\n\\t\\t\\tDiscover the unmatched advantages of our hosting services, designed to elevate your gaming\\n\\t\\t\\texperience.\\n\\t\\t</p>\\n\\t\\t<div class=\\"grid gap-8 md:grid-cols-1 lg:grid-cols-2 items-stretch justify-center\\">\\n\\t\\t\\t<div\\n\\t\\t\\t\\tclass=\\"flex flex-col items-center justify-between space-y-4 border border-gray-700 p-8 rounded-lg bg-gray-800 shadow-lg h-full\\"\\n\\t\\t\\t\\taria-labelledby=\\"feature-1\\"\\n\\t\\t\\t>\\n\\t\\t\\t\\t<ServerIcon class=\\"h-16 w-16 mb-4 text-green-400\\" />\\n\\t\\t\\t\\t<h3 id=\\"feature-1\\" class=\\"text-2xl font-semibold text-gray-100 text-center\\">\\n\\t\\t\\t\\t\\tHigh-Performance\\n\\t\\t\\t\\t</h3>\\n\\t\\t\\t\\t<p class=\\"text-gray-400 text-center\\">\\n\\t\\t\\t\\t\\tBlazing fast servers optimized for gaming, ensuring minimal downtime and maximum\\n\\t\\t\\t\\t\\tenjoyment.\\n\\t\\t\\t\\t</p>\\n\\t\\t\\t</div>\\n\\t\\t\\t<div\\n\\t\\t\\t\\tclass=\\"flex flex-col items-center justify-between space-y-4 border border-gray-700 p-8 rounded-lg bg-gray-800 shadow-lg h-full\\"\\n\\t\\t\\t\\taria-labelledby=\\"feature-2\\"\\n\\t\\t\\t>\\n\\t\\t\\t\\t<ShieldCheckIcon class=\\"h-16 w-16 mb-4 text-green-400\\" />\\n\\t\\t\\t\\t<h3 id=\\"feature-2\\" class=\\"text-2xl font-semibold text-gray-100 text-center\\">Security</h3>\\n\\t\\t\\t\\t<p class=\\"text-gray-400 text-center\\">\\n\\t\\t\\t\\t\\tRobust security measures to keep your games running smoothly and securely, free from\\n\\t\\t\\t\\t\\tdisruptions.\\n\\t\\t\\t\\t</p>\\n\\t\\t\\t</div>\\n\\t\\t\\t<div\\n\\t\\t\\t\\tclass=\\"flex flex-col items-center justify-between space-y-4 border border-gray-700 p-8 rounded-lg bg-gray-800 shadow-lg h-full\\"\\n\\t\\t\\t\\taria-labelledby=\\"feature-3\\"\\n\\t\\t\\t>\\n\\t\\t\\t\\t<ZapIcon class=\\"h-16 w-16 mb-4 text-green-400\\" />\\n\\t\\t\\t\\t<h3 id=\\"feature-3\\" class=\\"text-2xl font-semibold text-gray-100 text-center\\">Low Latency</h3>\\n\\t\\t\\t\\t<p class=\\"text-gray-400 text-center\\">\\n\\t\\t\\t\\t\\tGlobal network infrastructure that guarantees low latency, ensuring a seamless gaming\\n\\t\\t\\t\\t\\texperience.\\n\\t\\t\\t\\t</p>\\n\\t\\t\\t</div>\\n\\t\\t\\t<div\\n\\t\\t\\t\\tclass=\\"flex flex-col items-center justify-between space-y-4 border border-gray-700 p-8 rounded-lg bg-gray-800 shadow-lg h-full\\"\\n\\t\\t\\t\\taria-labelledby=\\"feature-4\\"\\n\\t\\t\\t>\\n\\t\\t\\t\\t<DollarSignIcon class=\\"h-16 w-16 mb-4 text-green-400\\" />\\n\\t\\t\\t\\t<h3 id=\\"feature-4\\" class=\\"text-2xl font-semibold text-gray-100 text-center\\">\\n\\t\\t\\t\\t\\tCompetitive Pricing\\n\\t\\t\\t\\t</h3>\\n\\t\\t\\t\\t<p class=\\"text-gray-400 text-center\\">\\n\\t\\t\\t\\t\\tAffordable and transparent pricing plans tailored for every budget, ensuring value without\\n\\t\\t\\t\\t\\tcompromise.\\n\\t\\t\\t\\t</p>\\n\\t\\t\\t</div>\\n\\t\\t</div>\\n\\t</div>\\n</section>\\n\\n<style>\\n\\t.container {\\n\\t\\tmax-width: 1200px; /* Maintain a max width for better readability */\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAsEC,yBAAW,CACV,SAAS,CAAE,MACZ"}`
};
const Features = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<section id="features" class="w-full py-16 md:py-28 lg:py-36 bg-gradient-to-r from-gray-800 to-gray-900"><div class="container mx-auto px-6 lg:px-8 svelte-1fbxhmw"><h2 class="text-4xl font-extrabold tracking-tight sm:text-5xl text-center mb-10 text-white" data-svelte-h="svelte-z3axta">Why Choose Hostpro?</h2> <p class="text-lg text-gray-300 text-center mb-12" data-svelte-h="svelte-1uplcfr">Discover the unmatched advantages of our hosting services, designed to elevate your gaming
			experience.</p> <div class="grid gap-8 md:grid-cols-1 lg:grid-cols-2 items-stretch justify-center"><div class="flex flex-col items-center justify-between space-y-4 border border-gray-700 p-8 rounded-lg bg-gray-800 shadow-lg h-full" aria-labelledby="feature-1">${validate_component(Server, "ServerIcon").$$render($$result, { class: "h-16 w-16 mb-4 text-green-400" }, {}, {})} <h3 id="feature-1" class="text-2xl font-semibold text-gray-100 text-center" data-svelte-h="svelte-1bh3dhu">High-Performance</h3> <p class="text-gray-400 text-center" data-svelte-h="svelte-1uk7ns5">Blazing fast servers optimized for gaming, ensuring minimal downtime and maximum
					enjoyment.</p></div> <div class="flex flex-col items-center justify-between space-y-4 border border-gray-700 p-8 rounded-lg bg-gray-800 shadow-lg h-full" aria-labelledby="feature-2">${validate_component(Shield_check, "ShieldCheckIcon").$$render($$result, { class: "h-16 w-16 mb-4 text-green-400" }, {}, {})} <h3 id="feature-2" class="text-2xl font-semibold text-gray-100 text-center" data-svelte-h="svelte-1cdtwit">Security</h3> <p class="text-gray-400 text-center" data-svelte-h="svelte-13d0shp">Robust security measures to keep your games running smoothly and securely, free from
					disruptions.</p></div> <div class="flex flex-col items-center justify-between space-y-4 border border-gray-700 p-8 rounded-lg bg-gray-800 shadow-lg h-full" aria-labelledby="feature-3">${validate_component(Zap, "ZapIcon").$$render($$result, { class: "h-16 w-16 mb-4 text-green-400" }, {}, {})} <h3 id="feature-3" class="text-2xl font-semibold text-gray-100 text-center" data-svelte-h="svelte-1hcm2js">Low Latency</h3> <p class="text-gray-400 text-center" data-svelte-h="svelte-jsm9jw">Global network infrastructure that guarantees low latency, ensuring a seamless gaming
					experience.</p></div> <div class="flex flex-col items-center justify-between space-y-4 border border-gray-700 p-8 rounded-lg bg-gray-800 shadow-lg h-full" aria-labelledby="feature-4">${validate_component(Dollar_sign, "DollarSignIcon").$$render($$result, { class: "h-16 w-16 mb-4 text-green-400" }, {}, {})} <h3 id="feature-4" class="text-2xl font-semibold text-gray-100 text-center" data-svelte-h="svelte-3wxbht">Competitive Pricing</h3> <p class="text-gray-400 text-center" data-svelte-h="svelte-1n480vu">Affordable and transparent pricing plans tailored for every budget, ensuring value without
...
//# sourceMappingURL=_page.svelte-CZ990lLq.js.map
