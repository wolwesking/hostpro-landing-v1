...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const securityLayers = [
    ...
    {
      title: "6. IP Tables",
      description: "Iptables blocks malicious IPs, and automatically bans IPs involved in suspicious activities."
    },
    {
      title: "7. Traffic Filtering & Rate Limiting (Final Layer)",
      description: "Final traffic filtering and rate-limiting before reaching the servers."
...
//# sourceMappingURL=_page.svelte-bUyGQpcL.js.map
